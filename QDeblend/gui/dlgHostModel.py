...
class dlgHostModel(QDialog, ui_dlgHostModel.Ui_dlgHostModel):
    def __init__(self, hostContainer, parent=None):
        ...
        if self.container.models()>0:
            if self.dispHostModel.image is None:
                self.dispHostModel.image=self.dispHostModel.axes.imshow(numpy.ones(self.container.dim), origin='lower',
            ...
            self.dispHostModel.image=self.dispHostModel.axes.imshow(numpy.ones(self.container.dim),
    ...
    def updateTable(self, current=None):
        ...
        self.tableHost.setHorizontalHeaderLabels(["Magnitude", "Delta x", "Delta y", "Eff. Radius", "Sersic index",
                                                  "Ellipticity", "PA"])
        selected=None
    ...
    def deleteModel(self):
         if self.container.selected is not None:
